...
public class FeedbackResponsesLogicTest extends BaseLogicTest {
        ...
        public void testUpdateFeedbackResponseCascade() throws Exception {
                ...
                FeedbackResponseAttributes existingResponse = FeedbackResponseAttributes.builder(
                                responseToUpdate.getFeedbackQuestionId(), responseToUpdate.getGiver(),
                ...
                EntityAlreadyExistsException eaee = assertThrows(EntityAlreadyExistsException.class,
                                () -> frLogic.updateFeedbackResponseCascade(
                                                FeedbackResponseAttributes
                                                                .updateOptionsBuilder(finalResponse[0].getId())
                ...
                assertEquals(responseToUpdate.toString(),
                                frLogic.getFeedbackResponse(responseToUpdate.getFeedbackQuestionId(),
                                                responseToUpdate.getGiver(),
                ...
                List<FeedbackResponseCommentAttributes> associatedComments = frcLogic
                                .getFeedbackResponseCommentForResponse(updatedResponse.getId());
        ...
        public void testUpdateFeedbackResponsesForChangingTeam_typicalData_shouldDoCascadeDeletion() throws Exception {
                ...
                frLogic.updateFeedbackResponsesForChangingTeam(
                                studentToUpdate.getCourse(), studentToUpdate.getEmail(), studentToUpdate.getTeam(),
                                "Team 1.2");
        ...
        public void testUpdateFeedbackResponsesForChangingTeam_deleteLastResponse_decreaseResponseRate() {
                FeedbackResponseAttributes responseShouldBeDeleted = getResponseFromDatabase(questionTypeBundle,
                                "response1ForQ1ContribSession2Course2");
                ...
                frLogic.updateFeedbackResponsesForChangingTeam(student.getCourse(), student.getEmail(),
                                student.getTeam(),
                                student.getTeam() + "tmp");
        ...
        public void testUpdateResponsesForDeletingStudent_rankRecipientQuestionResponse_newResponsesShouldBeConsistent()
                ...
                FeedbackQuestionAttributes distinctRankQuestion = getQuestionFromDatabase(questionTypeBundle,
                                "qn1InRANKSession");
                ...
                while (!studentsInCourse.isEmpty()) {
                        ...
                        for (StudentAttributes student : studentsInCourse) {
                                ...
                                assertTrue(areRankResponsesInSameOrder(giverResponseMap.get(student.getEmail()),
                                                responsesFromStudent));
                                giverResponseMap.put(student.getEmail(), responsesFromStudent);
                        }
                }

                refreshTestData();
                FeedbackQuestionAttributes nonDistinctRankQuestion = getQuestionFromDatabase(questionTypeBundle,
                                "qn2InRANKSession");
        ...
        private boolean areRankResponsesConsistent(List<FeedbackResponseAttributes> responses, int maxRank) {
                for (FeedbackResponseAttributes response : responses) {
                        ...
                        FeedbackRankRecipientsResponseDetails responseDetails = (FeedbackRankRecipientsResponseDetails) response
                                        .getResponseDetails();
        ...
        /**
         * Checks whether two list of responses for 'rank recipient question' have the
         * same order for each recipient.
         * The recipients of the updated responses should be a subset of that of the
         * original responses.
         * 
         * @param responses         the original response list
         * @param modifiedResponses the updated response list
         * @return true if the modified response list maintain the original order of the
         *         responses
         */
        private boolean areRankResponsesInSameOrder(List<FeedbackResponseAttributes> responses,
                ...
                responses.sort(Comparator.comparing(
                                response -> ((FeedbackRankRecipientsResponseDetails) response.getResponseDetails())
                                                .getAnswer()));
        ...
        private int numResponsesFromGiverInSession(String studentEmail, String sessionName, String courseId) {
                ...
                for (FeedbackResponseAttributes response : questionTypeBundle.feedbackResponses.values()) {
                        if (response.getGiver().equals(studentEmail)
                                        && response.getFeedbackSessionName().equals(sessionName)
        ...
        public void testUpdateFeedbackResponsesForChangingEmail() throws Exception {
                ...
                // Student 1 currently has 1 response comment for responses from instructor to
                // him
                ...
                List<FeedbackResponseAttributes> responsesForReceiver = frLogic
                                .getFeedbackResponsesForReceiverForCourse(
                                                studentToUpdate.getCourse(), studentToUpdate.getEmail());
                List<FeedbackResponseAttributes> responsesFromGiver = frLogic.getFeedbackResponsesFromGiverForCourse(
                                studentToUpdate.getCourse(), studentToUpdate.getEmail());
                Set<String> responseIdsToAndFromStudent = new HashSet<>();
                responseIdsToAndFromStudent.addAll(
                                responsesForReceiver.stream().map(FeedbackResponseAttributes::getId)
                                                .collect(Collectors.toList()));
                responseIdsToAndFromStudent.addAll(
                                responsesFromGiver.stream().map(FeedbackResponseAttributes::getId)
                                                .collect(Collectors.toList()));
                List<FeedbackResponseCommentAttributes> responseCommentsForStudent = getFeedbackResponseCommentsForResponsesFromDatabase(
                                responseIdsToAndFromStudent);
                ...
                responseIdsToAndFromStudent.addAll(
                                responsesFromGiver.stream().map(FeedbackResponseAttributes::getId)
                                                .collect(Collectors.toList()));
                responseCommentsForStudent = getFeedbackResponseCommentsForResponsesFromDatabase(
                                responseIdsToAndFromStudent);
        ...
        public void testIsResponseVisibleForUser() {
                ...
                FeedbackQuestionAttributes fq11 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn1InSession1InCourse1");
                // stu -> stu : instructors, receiver
                FeedbackQuestionAttributes fq12 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn2InSession1InCourse1");
                // self -> none : other students, instructors
                FeedbackQuestionAttributes fq13 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn3InSession1InCourse1");
                // team -> ins : instructors, other students
                FeedbackQuestionAttributes fq16 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn6InSession1InCourse1");
                // stu -> stu in same section : own team members, receiver team members
                FeedbackQuestionAttributes fq17 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn7InSession1InCourse1");
                // ins -> ins : -
                FeedbackQuestionAttributes fq18 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn8InSession1InCourse1");
                // ins -> ins team : instructors
                FeedbackQuestionAttributes fq19 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn9InSession1InCourse1");
                // team -> team : receiver
                FeedbackQuestionAttributes fq21 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn1InSession2InCourse1");
                // stu -> own team mem : receiver, own team members
                FeedbackQuestionAttributes fq22 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn2InSession2InCourse1");
                // ins -> stu : receiver, instructors, other students, receiver's team members
                FeedbackQuestionAttributes fq23 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn3InSession2InCourse1");
                // stu -> ins : receiver
                FeedbackQuestionAttributes fq24 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn4InSession2InCourse1");
                // stu -> own team : own team members, instructors
                FeedbackQuestionAttributes fq25 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn5InSession2InCourse1");
                // stu -> team : other students
                FeedbackQuestionAttributes fq26 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn6InSession2InCourse1");
                // team -> stu in same section : instructors
                FeedbackQuestionAttributes fq27 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn7InSession2InCourse1");
                // team -> team in same section : receiver
                FeedbackQuestionAttributes fq28 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn8InSession2InCourse1");
                // stu -> team in same section : instructors
                FeedbackQuestionAttributes fq29 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn9InSession2InCourse1");
                // stu -> team excluding self : instructors, receiver
                FeedbackQuestionAttributes fq30 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn11InSession2InCourse1");
                // ins -> team : instructors
                FeedbackQuestionAttributes fq20 = responseVisibilityBundle.feedbackQuestions
                                .get("FRV.qn10InSession2InCourse1");

                // stu1 -> stu1 (self feedback)
                FeedbackResponseAttributes fr111 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ1S1C1");
                // stu5 -> stu5 (self feedback)
                FeedbackResponseAttributes fr112 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response2ForQ1S1C1");
                // stu2 -> stu5
                FeedbackResponseAttributes fr121 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ2S1C1");
                // stu5 -> stu2
                FeedbackResponseAttributes fr122 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response2ForQ2S1C1");
                // stu3 -> stu2
                FeedbackResponseAttributes fr123 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response3ForQ2S1C1");
                // ins1 -> General
                FeedbackResponseAttributes fr131 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ3S1C1");
                // team2 -> ins2
                FeedbackResponseAttributes fr161 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ6S1C1");
                // team3 -> ins2
                FeedbackResponseAttributes fr162 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response2ForQ6S1C1");
                // stu1 -> stu6
                FeedbackResponseAttributes fr171 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ7S1C1");
                // ins1 -> ins2
                FeedbackResponseAttributes fr181 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ8S1C1");
                // ins2 -> ins team
                FeedbackResponseAttributes fr191 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ9S1C1");
                // team1 -> team2
                FeedbackResponseAttributes fr211 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ1S2C1");
                // stu4 -> stu3
                FeedbackResponseAttributes fr221 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ2S2C1");
                // ins1 -> stu3
                FeedbackResponseAttributes fr231 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ3S2C1");
                // ins6 -> stu5
                FeedbackResponseAttributes fr232 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response2ForQ3S2C1");
                // stu1 -> ins1
                FeedbackResponseAttributes fr241 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ4S2C1");
                // stu1 -> ins4
                FeedbackResponseAttributes fr242 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response2ForQ4S2C1");
                // stu6 -> team3 (own team)
                FeedbackResponseAttributes fr251 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ5S2C1");
                // stu5 -> team2 (own team)
                FeedbackResponseAttributes fr252 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response2ForQ5S2C1");
                // stu1 -> team3
                FeedbackResponseAttributes fr261 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ6S2C1");
                // team1 -> stu7
                FeedbackResponseAttributes fr271 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ7S2C1");
                // team3 -> team1
                FeedbackResponseAttributes fr281 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ8S2C1");
                // stu8 -> team1
                FeedbackResponseAttributes fr291 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ9S2C1");
                // stu1 -> team2
                FeedbackResponseAttributes fr2111 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ11S2C1");
                // stu6 -> team1
                FeedbackResponseAttributes fr2112 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response2ForQ11S2C1");
                // stu7 -> team2
                FeedbackResponseAttributes fr2113 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response3ForQ11S2C1");
                // ins2 -> team2
                FeedbackResponseAttributes fr201 = responseVisibilityBundle.feedbackResponses
                                .get("FRV.response1ForQ10S2C1");

                Set<String> studentsEmailInTeam1 = new HashSet<>(
                                Arrays.asList(student1.getEmail(), student2.getEmail(), student3.getEmail(),
                                                student4.getEmail()));
                Set<String> studentsEmailInTeam2 = new HashSet<>(Arrays.asList(student5.getEmail()));
                Set<String> studentsEmailInTeam3 = new HashSet<>(
                                Arrays.asList(student6.getEmail(), student7.getEmail()));
        ...
        public void testDeleteFeedbackResponsesInvolvedEntityOfCourseCascade_shouldDeleteRelatedResponses() {
                ...
                remainingResponses.addAll(
                                frLogic.getFeedbackResponsesFromGiverForCourse(studentToDelete.getCourse(),
                                                studentToDelete.getEmail()));
                remainingResponses.addAll(
                                frLogic.getFeedbackResponsesForReceiverForCourse(studentToDelete.getCourse(),
                                                studentToDelete.getEmail()));
                assertFalse(remainingResponses.isEmpty());

                // the student has some responses
                List<FeedbackResponseAttributes> responsesForStudent1 = frLogic.getFeedbackResponsesFromGiverForCourse(
        ...
        public void testDeleteFeedbackResponses_byCourseId() {
                ...
                assertFalse(frLogic.getFeedbackResponsesForSession("Instructor feedback session", otherCourse)
                                .isEmpty());
        }
        ...
        public void testDeleteFeedbackResponsesForQuestionCascade_studentsQuestion_shouldUpdateRespondents() {
                ...
                assertEquals(1, frLogic.getFeedbackResponsesFromGiverForCourse(fra.getCourseId(), fra.getGiver())
                                .stream()
                                .filter(response -> response.getFeedbackSessionName()
                                                .equals(fra.getFeedbackSessionName()))
                                .count());
        ...
        public void testDeleteFeedbackResponsesInvolvedEntityOfCourseCascade_shouldDeleteRelevantResponsesAsRecipient()
                ...
                frLogic.deleteFeedbackResponsesInvolvedEntityOfCourseCascade(fra1ReceivedByTeam.getCourseId(),
                                teamName);
        ...
        public void testDeleteFeedbackResponsesInvolvedEntityOfCourseCascade_shouldDeleteRelevantResponsesAsGiver()
                ...
                // the following two responses are given by student4InCourse1 as a
                // representative of his team
        ...
        public void testGetSessionResultsForUser_studentSpecificQuestion_shouldHaveCorrectResponsesFiltered() {
                ...
                List<FeedbackResponseAttributes> responseForQuestion = bundle.getQuestionResponseMap().entrySet()
        ...
        public void testGetSessionResultsForUser_studentAllQuestions_shouldGenerateCorrectBundle() {
                ...
                int totalResponse = 0;
                for (Map.Entry<String, List<FeedbackResponseAttributes>> entry : bundle.getQuestionResponseMap()
                                .entrySet()) {
                        totalResponse += entry.getValue().size();
                }
                int totalMissingResponse = 0;
                for (Map.Entry<String, List<FeedbackResponseAttributes>> entry : bundle.getQuestionMissingResponseMap()
                                .entrySet()) {
                ...
                // preview invisibility info should be empty because this is NOT previewing
                // results
                ...
                // instructors can see responses (when previewing results as the student):
                // qr4r2-3
                totalResponse = 0;
                for (Map.Entry<String, List<FeedbackResponseAttributes>> entry : bundle.getQuestionResponseMap()
                                .entrySet()) {
        ...
        public void testGetSessionResultsForCourse_allQuestionsSpecificSection_shouldGenerateCorrectBundle() {
                ...
                // Instructor can see responses: q2r1-3, q3r1-2, q4r1-3, q5r1, q6r1
                // after filtering by section, the number of responses seen by instructor will
                // differ.
        ...
        public void testGetSessionResultsForCourse_responseFetchByGiverOrReceiverOnly_shouldGenerateCorrectBundle() {
                ...
                Map<String, List<FeedbackResponseAttributes>> questionResponseMapByGiver = frLogic
                                .getSessionResultsForCourse(
                ...
                Map<String, List<FeedbackResponseAttributes>> questionResponseMapByReceiver = frLogic
                                .getSessionResultsForCourse(
                                                session.getFeedbackSessionName(), session.getCourseId(),
                                                instructor.getEmail(),
        ...
        public void testGetSessionResultsForCourse_splitResponseFetchByGiverAndReceiver_shouldGenerateCorrectBundle() {
                ...
                InstructorAttributes instructor = responseBundle.instructors.get("instructor1OfCourse1");
                Map<String, List<FeedbackResponseAttributes>> questionResponseMapFromMultiFetch = frLogic
                                .getSessionResultsForCourse(
                                                session.getFeedbackSessionName(), session.getCourseId(),
                                                instructor.getEmail(),
                                                null, "Section A", FeedbackResultFetchType.GIVER)
                                .getQuestionResponseMap();
                ...
                Map<String, List<FeedbackResponseAttributes>> questionResponseMapFromFetchBoth = frLogic
                                .getSessionResultsForCourse(
                                                session.getFeedbackSessionName(), session.getCourseId(),
                                                instructor.getEmail(),
                                                null, "Section A", FeedbackResultFetchType.BOTH)
                ...
                for (var entry : questionResponseMapFromFetchBoth.entrySet()) {
                        ...
                        List<FeedbackResponseAttributes> respFromMultiFetch = questionResponseMapFromMultiFetch
                                        .get(entry.getKey());
        ...
        public void testGetSessionResultsForUser_orphanResponseInDB_shouldStillHandleCorrectly() throws Exception {
                ...
                FeedbackResponseAttributes newResponse = FeedbackResponseAttributes.builder(
                                existingResponse.getFeedbackQuestionId(), existingResponse.getGiver(),
        ...
        public void testIfTheFunctionOfIsResponseOfFeedbackQuestionVisibleToStudentIsWorkingForEmptyInformations() {
                ...
                question.setShowResponsesTo(list);
                question.setRecipientType(FeedbackParticipantType.NONE);
                FeedbackResponsesLogic instance = FeedbackResponsesLogic.inst();
        ...
        public void testIfTheFunctionOfIsResponseOfFeedbackQuestionVisibleToStudentIsWorkingOnlyForRecieversAndRecipientTypeIsAGiverAndGuiverIsAStudent() {
                ...
                list.add(FeedbackParticipantType.RECEIVER);
                question.setShowResponsesTo(list);
                question.setRecipientType(FeedbackParticipantType.GIVER);
                question.setGiverType(FeedbackParticipantType.STUDENTS);
                FeedbackResponsesLogic instance = FeedbackResponsesLogic.inst();
        ...
        private FeedbackResponseAttributes getResponseFromDatabase(DataBundle dataBundle, String jsonId) {
                ...
                try {
                        ...
                        qnId = fqLogic.getFeedbackQuestion(response.getFeedbackSessionName(), response.getCourseId(),
                                        qnNumber).getId();
        ...
        private List<FeedbackResponseCommentAttributes> getFeedbackResponseCommentsForResponsesFromDatabase(
                ...
                for (String id : responseIds) {
                        List<FeedbackResponseCommentAttributes> responseCommentsForResponse = frcLogic
                                        .getFeedbackResponseCommentForResponse(id);
